...
<head>
    ...
    <title>Mersoft</title>
    <link rel="apple-touch-icon" href="https://imagensemoldes.com.br/wp-content/uploads/2021/02/Letra-M-PNG-1.png">
    <link rel="shortcut icon" href="https://imagensemoldes.com.br/wp-content/uploads/2021/02/Letra-M-PNG-1.png">
    <!-- Scripts -->
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
            <a class="navbar-brand fst-italic fw-bold fs-2 text-primary " href="{{ route('home') }}">
                    Mersoft
                </a>
